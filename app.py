...
print("Setting up software store(app-grid for now)...")
print("This can take a lot of time as the servers are slow.")
subprocess.call("sudo add-apt-repository ppa:appgrid/stable", shell = True)
subprocess.call("sudo apt-get update", shell = True)
subprocess.call("sudo apt-get install appgrid", shell = True)
